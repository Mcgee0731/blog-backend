  ...
  <div class="layout">
    ...
    <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
        <div class="container px-4 px-lg-5">
            <g-link class="navbar-brand" to="/" >Personal Blog</g-link>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto py-4 py-lg-0">
                    ...
                    <!-- <li class="nav-item"><g-link class="nav-link px-lg-3 py-3 py-lg-4" href="/post/">Sample Post</g-link></li> -->
        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-md-10 col-lg-8 col-xl-7">
                    ...
                    <div class="small text-center text-muted fst-italic"> &copy; Website 2021</div>
                </div>
            </div>
        </div>
    </footer> 
